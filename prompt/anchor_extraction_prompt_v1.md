...
Then select the best candidate as selected_anchor. The final anchor must use
the form "specific object + specific aspect" whenever the segment contains
both a specific object and a specific aspect.
