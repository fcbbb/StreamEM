# 已审核的 60 个 session 标注索引

边界的右侧是新事件起点；`turn/sentence` 用于回到原始对话定位。

## session_0001 (no_memory/none)

- units: 35; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
...
- units: 35; segments: 5; types: greeting, substantive, substantive, substantive, goodbye; status: `reviewed`
...
- 边界 3：after `u030` (turn 18/1) → before `u031` (turn 18/2)
  - 左：That's an interesting connection to make, seeing the abstract in everyday transactions.
  - 右：How many steps did you get today?
- 边界 4：after `u034` (turn 20/1) → before `u035` (turn 21/1)
  - 左：I'm glad you had a relaxed day; feel free to ask if anything else comes to mind!
  - 右：Thanks, you too!

## session_0003 (no_memory/none)

- units: 21; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
...
- 边界 2：after `u019` (turn 10/2) → before `u020` (turn 11/1)
  - 左：Thanks for clarifying!
  - 右：You're most welcome!

## session_0004 (activity/add)

- units: 35; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
  - 左：That's great to hear!
...
- units: 37; segments: 3; types: greeting, substantive, substantive; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'd be happy to help.
  - 右：What can I assist you with today?
...
- units: 34; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u028` (turn 14/2) → before `u029` (turn 15/1)
...
- 边界 2：after `u031` (turn 16/2) → before `u032` (turn 17/1)
...
- units: 26; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
  - 左：That's good to hear!
...
- units: 40; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u007` (turn 3/1) → before `u008` (turn 3/2)
  - 左：Great!
  - 右：I need to add a new project proposal to my content memory.
- 边界 2：after `u038` (turn 27/3) → before `u039` (turn 28/1)
  - 左：Feel free to reach out anytime you need assistance with organizing information or anything else.
  - 右：Will do!

## session_0009 (activity/add)

- units: 23; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'd be happy to help.
  - 右：What can I do for you today?
...
- units: 30; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
  - 左：Great!
...
- units: 40; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
  - 左：That's great to hear!
...
- units: 25; segments: 3; types: greeting, substantive, substantive; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'd be happy to help.
  - 右：What can I assist you with today?
...
- units: 29; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'd be happy to help.
  - 右：What can I assist you with today?
- 边界 2：after `u028` (turn 14/2) → before `u029` (turn 15/1)
  - 左：I've noted that all updates for the project proposal are complete.
  - 右：Thanks for your help!

## session_0014 (no_memory/none)

- units: 19; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u007` (turn 4/1) → before `u008` (turn 4/2)
  - 左：Sure, I can help with that.
  - 右：What were you looking for assistance with?
...
- units: 23; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
  - 左：I'm good!
  - 右：I need some help organizing information for a new social media post I want to create.
- 边界 2：after `u020` (turn 14/1) → before `u021` (turn 14/2)
  - 左：No, that's everything for now.
  - 右：This was really helpful; I'll definitely be back for more assistance!

## session_0016 (goal/add)

- units: 37; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
  - 左：That's great to hear!
...
- units: 28; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
...
- units: 32; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
  - 左：That's great to hear!
...
- units: 41; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
...
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'd be happy to help.
  - 右：What questions do you have for me?
...
- 边界 3：after `u028` (turn 16/1) → before `u029` (turn 17/1)
  - 左：I think that's all for now, but I'll probably have more questions about AI later.
  - 右：Sounds good!
...
- units: 20; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'd be happy to help in any way I can.
  - 右：What's on your mind?
...
- units: 27; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
  - 左：That's great to hear!
  - 右：Did you know that the average person has about 70,000 thoughts per day?
...
- 边界 3：after `u024` (turn 13/2) → before `u025` (turn 13/3)
...
- units: 31; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'm doing well, thank you.
...
- units: 33; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
...
- units: 25; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'm doing great, thanks for asking.
  - 右：How can I help you today?
- 边界 2：after `u024` (turn 15/2) → before `u025` (turn 15/3)
  - 左：Glad I could assist.
  - 右：Have a great day!
...
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
  - 左：That's great to hear!
  - 右：Is there anything specific you're looking to discuss or learn about today?
...
- units: 26; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
  - 左：That's productive!
...
- units: 24; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
  - 左：That's great!
...
- units: 29; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
  - 左：That's great to hear!
  - 右：Did you know that the average person has about 70,000 thoughts per day?
...
- units: 32; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u003` (turn 2/2) → before `u004` (turn 2/3)
  - 左：I'd be happy to help.
  - 右：What's on your mind?
...
- 边界 3：after `u030` (turn 19/1) → before `u031` (turn 20/1)
  - 左：Thanks, this has been a really interesting conversation.
  - 右：You're welcome!

## session_0043 (no_memory/none)

- units: 30; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u005` (turn 3/1) → before `u006` (turn 3/2)
  - 左：That's good to hear!
...
- units: 36; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
  - 左：That's great!
...
- 边界 2：after `u034` (turn 27/1) → before `u035` (turn 27/2)
  - 左：That's excellent!
  - 右：Feel free to reach out if you need assistance with any future projects.
...
- units: 22; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
...
- units: 22; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
  - 左：That's great to hear!
...
- units: 28; segments: 3; types: greeting, substantive, goodbye; status: `reviewed`
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'd be happy to help in any way I can.
  - 右：What can I assist you with today?
...
- 边界 1：after `u004` (turn 2/2) → before `u005` (turn 2/3)
  - 左：I'd be happy to help in any way I can.
  - 右：What can I assist you with today?
- 边界 2：after `u019` (turn 11/1) → before `u020` (turn 11/2)
  - 左：No, that's everything.
  - 右：Thanks for your help!

## session_0059 (activity/add)

- units: 25; segments: 4; types: greeting, substantive, substantive, goodbye; status: `reviewed`
- 边界 1：after `u006` (turn 3/1) → before `u007` (turn 3/2)
  - 左：That's great to hear!
